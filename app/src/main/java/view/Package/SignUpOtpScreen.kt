...
class SignUpOtpScreen : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // setting the layout
        setContentView(R.layout.activity_sign_up_otp_screen)
        // getting the instance of the button and pinview
        continueButton = findViewById(R.id.Verify_button)
        pinView = findViewById(R.id.pinview)
        // starting to listen for sms from server.
        startSmartUserConsent()
        //implementing on click event listener.
